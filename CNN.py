...
if __name__ == "__main__":
    ...
    y_pred = (model.predict(X_test) > 0.5).astype("int32").flatten()  # Threshold predictions at 0.5
    ...
    print("Saving model...")
    model.save('compost_vs_recyclable_cnn.h5')
    print("Model saved as 'compost_vs_recyclable_cnn.h5'")
